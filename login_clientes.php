...
if(isset($_SESSION['usuario'])){
  header("location:login_clientes/bienvenida.php");
}
...
<link href="https://fonts.googleapis.com/css2?family=Arvo&family=Roboto:ital,wght@0,100;0,300;0,400;0,500;0,900;1,100;1,300;1,400;1,500;1,700;1,900&display=swap" rel="stylesheet">  
  ...
  <body>
    <main>
      <div class="contenedor__todo">
        ...
        <div class="contenedor__login-register">
            <!--formulario de login -->
          <form action="login_clientes/login_usuario_be.php" method="POST" class="formulario__login">
          ...
          <form action="login_clientes/registro_usuario_be.php" method="POST" class="formulario__register">
            <h2>Registrarse</h2>
    ...
    <script src="js/script_ingreso_cliente.js">
  </body>
</html>