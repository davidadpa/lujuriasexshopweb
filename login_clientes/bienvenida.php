...
<html lang="es">
  <head>
    ...
    <link rel="stylesheet" href="../CSS\style-bien.css"> <!--conexion con el archivo css-->
  ...
  <body>
    ...
    <ul class="menu"> <!-- se crea el menu principal sin especificar ruta-->
      <li><a href="../vibradores.php">Vibradores</a></li>
      <li><a href="../consoladores.php">Consoladores</a></li>
      <li><a href="../jugetes_anales.php">Jugetes anales</a></li>
      <li><a href="../hombres.php">Hombres</a></li>
      <li><a href="../lubricantes.php">Aceites y lubricantes</a></li>
      <li><a href="../lenceria.php">Lenceria</a></li>
      <li><a href="../sado.php">Sado y Fetiche</a></li>
